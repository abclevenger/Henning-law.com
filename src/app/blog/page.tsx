...
const blogPosts: BlogPost[] = [
    {
        id: 1,
        title: {
            en: "Understanding the E-2 Treaty Investor Visa",
            de: "Das E-2 Investorenvisum verstehen",
            es: "Entendiendo la visa de inversionista E-2",
            fr: "Comprendre le visa investisseur E-2",
            zh: "了解E-2条约投资者签证",
            ja: "E-2条約投資家ビザを理解する",
            ar: "فهم تأشيرة المستثمر E-2",
        },
        excerpt: {
            ...
            zh: "E-2签证允许条约国公民投资和经营美国企业。了解资格要求、投资门槛和申请流程。",
            ja: "E-2ビザは条約国の市民が米国企業に投資し運営することを可能にします。資格要件、投資額、申請プロセスについて学びましょう。",
            ar: "تسمح تأشيرة E-2 لمواطني الدول الموقعة على المعاهدة بالاستثمار وتشغيل عمل تجاري أمريكي. تعرف على متطلبات الأهلية وعملية التقديم.",
        },
        category: {
            en: "Visas", de: "Visa", es: "Visas", fr: "Visas", zh: "签证", ja: "ビザ", ar: "التأشيرات"
        },
        date: {
            en: "Coming Soon", de: "Demnächst", es: "Próximamente", fr: "Bientôt", zh: "即将推出", ja: "近日公開", ar: "قريباً"
        }
    },
    {
        id: 2,
        title: {
            en: "EB-5 Investor Program: What You Need to Know",
            de: "EB-5 Investorenprogramm: Was Sie wissen müssen",
            es: "Programa de inversionistas EB-5: Lo que necesita saber",
            fr: "Programme investisseur EB-5 : Ce que vous devez savoir",
            zh: "EB-5投资者计划：您需要了解的内容",
            ja: "EB-5投資家プログラム：知っておくべきこと",
            ar: "برنامج المستثمر EB-5: ما تحتاج إلى معرفته",
        },
        excerpt: {
            ...
            zh: "EB-5计划通过在美国企业的大量投资提供获得永久居留权的途径。",
            ja: "EB-5プログラムは、米国企業への多額の投資を通じて永住権への道を提供します。",
            ar: "يوفر برنامج EB-5 طريقًا للإقامة الدائمة من خلال استثمار كبير في الشركات الأمريكية.",
        },
        category: {
            en: "Green Cards", de: "Green Cards", es: "Tarjetas verdes", fr: "Cartes vertes", zh: "绿卡", ja: "グリーンカード", ar: "البطاقات الخضراء"
        },
        date: {
            en: "Coming Soon", de: "Demnächst", es: "Próximamente", fr: "Bientôt", zh: "即将推出", ja: "近日公開", ar: "قريباً"
        }
    },
    {
        id: 3,
        title: {
            en: "Marriage-Based Green Cards: A Step-by-Step Guide",
            de: "Ehepartner-Green Card: Schritt-für-Schritt-Anleitung",
            es: "Tarjetas verdes basadas en matrimonio: Guía paso a paso",
            fr: "Carte verte par mariage : Guide étape par étape",
            zh: "基于婚姻的绿卡：分步指南",
            ja: "結婚に基づくグリーンカード：ステップバイステップガイド",
            ar: "البطاقة الخضراء القائمة على الزواج: دليل خطوة بخطوة",
        },
        excerpt: {
            ...
            zh: "为配偶申请绿卡的过程可能很复杂。本指南详细介绍时间表、文件和面试准备。",
            ja: "配偶者のグリーンカードをスポンサーするプロセスは複雑な場合があります。このガイドでは、タイムライン、書類、面接準備について説明します。",
            ar: "يمكن أن تكون عملية كفالة زوجك للحصول على البطاقة الخضراء معقدة. يوضح هذا الدليل الجدول الزمني والوثائق والتحضير للمقابلة.",
        },
        category: {
    ...
    },
    {
        id: 4,
        title: {
            en: "Starting a Business in the U.S. as a Foreign National",
            de: "Unternehmensgründung in den USA als Ausländer",
            es: "Iniciar un negocio en EE.UU. como extranjero",
            fr: "Créer une entreprise aux États-Unis en tant qu'étranger",
            zh: "作为外国人在美国创业",
            ja: "外国人として米国でビジネスを始める",
            ar: "بدء عمل تجاري في الولايات المتحدة كأجنبي",
        },
        excerpt: {
            ...
            zh: "了解希望在美国建立业务的国际企业家的实体设立、签证考虑和法律要求。",
            ja: "米国でのプレゼンスを確立しようとする国際的な起業家のための法人設立、ビザの考慮事項、法的要件について学びましょう。",
            ar: "تعرف على تكوين الكيانات واعتبارات التأشيرة والمتطلبات القانونية لرواد الأعمال الدوليين.",
        },
        category: {
            en: "Business", de: "Geschäft", es: "Negocios", fr: "Affaires", zh: "商业", ja: "ビジネス", ar: "الأعمال"
        },
        date: {
            en: "Coming Soon", de: "Demnächst", es: "Próximamente", fr: "Bientôt", zh: "即将推出", ja: "近日公開", ar: "قريباً"
        }
    },
    {
        id: 5,
        title: {
            en: "The Path to U.S. Citizenship: Naturalization Requirements",
            de: "Der Weg zur US-Staatsbürgerschaft: Einbürgerungsvoraussetzungen",
            es: "El camino a la ciudadanía estadounidense: Requisitos de naturalización",
            fr: "Le chemin vers la citoyenneté américaine : Exigences de naturalisation",
            zh: "通往美国公民身份之路：入籍要求",
            ja: "米国市民権への道：帰化要件",
            ar: "الطريق إلى الجنسية الأمريكية: متطلبات التجنس",
        },
        excerpt: {
            ...
            zh: "对于准备成为美国公民的永久居民来说，了解入籍流程至关重要。",
            ja: "米国市民になる準備ができている永住者にとって、帰化プロセスを理解することは不可欠です。",
            ar: "بالنسبة للمقيمين الدائمين المستعدين ليصبحوا مواطنين أمريكيين، فإن فهم عملية التجنس أمر ضروري.",
        },
        category: {
            en: "Citizenship", de: "Staatsbürgerschaft", es: "Ciudadanía", fr: "Citoyenneté", zh: "公民身份", ja: "市民権", ar: "الجنسية"
        },
        date: {
            en: "Coming Soon", de: "Demnächst", es: "Próximamente", fr: "Bientôt", zh: "即将推出", ja: "近日公開", ar: "قريباً"
        }
    },
    {
        id: 6,
        title: {
            en: "Buying Property in the U.S. as a Non-Resident",
            de: "Immobilienkauf in den USA als Nicht-Resident",
            es: "Comprar propiedad en EE.UU. como no residente",
            fr: "Acheter une propriété aux États-Unis en tant que non-résident",
            zh: "非居民在美国购买房产",
            ja: "非居住者として米国で不動産を購入する",
            ar: "شراء عقار في الولايات المتحدة كغير مقيم",
        },
        excerpt: {
            ...
            zh: "非居民可以购买美国房地产，但有重要的税务和法律考虑。",
            ja: "非居住者は米国の不動産を購入できますが、重要な税務および法的考慮事項があります。",
            ar: "يمكن لغير المقيمين شراء العقارات الأمريكية، ولكن هناك اعتبارات ضريبية وقانونية مهمة.",
        },
        category: {
            en: "Real Estate", de: "Immobilien", es: "Bienes raíces", fr: "Immobilier", zh: "房地产", ja: "不動産", ar: "العقارات"
        },
        date: {
            en: "Coming Soon", de: "Demnächst", es: "Próximamente", fr: "Bientôt", zh: "即将推出", ja: "近日公開", ar: "قريباً"
        }
...
const uiText = {
    pageTitle: {
        ...
        fr: "Blog et ressources", zh: "博客与资源", ja: "ブログとリソース", ar: "المدونة والموارد"
    },
    heroSubtitle: {
        ...
        zh: "关于美国移民、签证和相关法律主题的见解和指导。",
        ja: "米国移民、ビザ、関連する法的トピックに関する洞察とガイダンス。",
        ar: "رؤى وإرشادات حول الهجرة إلى الولايات المتحدة والتأشيرات والموضوعات القانونية ذات الصلة.",
    },
    comingSoonTitle: {
        en: "Blog Coming Soon", de: "Blog demnächst verfügbar", es: "Blog próximamente",
        fr: "Blog bientôt disponible", zh: "博客即将推出", ja: "ブログ近日公開", ar: "المدونة قريباً"
    },
    comingSoonText: {
        ...
        ja: "米国移民をナビゲートするための有益な記事とリソースを準備しています。更新をお待ちいただくか、直接お問い合わせください。",
        ar: "نحن نعد مقالات وموارد إعلامية لمساعدتك في التنقل في الهجرة إلى الولايات المتحدة. تحقق مرة أخرى قريبًا أو اتصل بنا مباشرة.",
    },
    upcomingTopics: {
        en: "Upcoming Topics", de: "Kommende Themen", es: "Temas próximos",
        fr: "Sujets à venir", zh: "即将推出的主题", ja: "今後のトピック", ar: "المواضيع القادمة"
    },
    ctaTitle: {
        en: "Need Answers Now?", de: "Brauchen Sie jetzt Antworten?", es: "¿Necesita respuestas ahora?",
        fr: "Besoin de réponses maintenant ?", zh: "现在需要答案吗？", ja: "今すぐ答えが必要ですか？", ar: "هل تحتاج إلى إجابات الآن؟"
    },
    ctaSubtitle: {
        ...
        zh: "不要等待我们的博客文章。预约咨询以讨论您的具体情况。",
        ja: "ブログ記事をお待ちにならないでください。ご相談を予約して、具体的な状況についてお話しください。",
        ar: "لا تنتظر منشورات مدونتنا. حدد موعدًا للاستشارة لمناقشة حالتك المحددة.",
    },
    ctaButton: {
