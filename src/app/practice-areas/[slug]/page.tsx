...
export default async function PracticeAreaPage({ params }: PageProps) {
  ...
  > = {
    ...
    'corporate-business-support': {
      ...
      goodFit: [
        'Your company has or is establishing U.S. operations or relocating executives',
      ...
      notIdeal: [
        ...
        'You do not require corporate or entity structuring support',
      ],
      useCases: [
