...
const faqs: FAQ[] = [
    ...
    },
    {
        ...
        question: {
            en: "Can you help with U.S. market entry and property ownership?",
            de: "Können Sie bei US-Markteintritt und Immobilieneigentum helfen?",
            es: "¿Pueden ayudar con la entrada al mercado estadounidense y la propiedad inmobiliaria?",
            fr: "Pouvez-vous aider avec l'entrée sur le marché américain et la propriété immobilière ?",
            zh: "您能帮助进入美国市场和房产所有权吗？",
            ja: "米国市場参入と不動産所有について支援できますか？",
            ar: "هل يمكنكم المساعدة في دخول السوق الأمريكي وملكية العقارات؟",
        },
        answer: {
            en: "Yes. We advise on market entry strategy, corporate structure, and legal considerations for property ownership as a non-resident. Our comprehensive approach addresses immigration, corporate, tax, and real estate considerations together.",
            de: "Ja. Wir beraten zu Markteintrittsstrategien, Unternehmensstruktur und rechtlichen Aspekten des Immobilieneigentums als Nicht-Resident. Unser ganzheitlicher Ansatz berücksichtigt Einwanderung, Unternehmens-, Steuer- und Immobilienfragen gemeinsam.",
            es: "Sí. Asesoramos sobre estrategia de entrada al mercado, estructura corporativa y consideraciones legales para la propiedad inmobiliaria como no residente.",
            fr: "Oui. Nous conseillons sur la stratégie d'entrée sur le marché, la structure d'entreprise et les considérations juridiques pour la propriété immobilière en tant que non-résident.",
            zh: "是的。我们就市场进入战略、公司结构和非居民房产所有权的法律考虑提供建议。",
            ja: "はい。市場参入戦略、企業構造、非居住者としての不動産所有に関する法的考慮事項についてアドバイスします。",
            ar: "نعم. نقدم المشورة بشأن استراتيجية دخول السوق والهيكل المؤسسي والاعتبارات القانونية لملكية العقارات كغير مقيم.",
        }
    },
    {
        id: 6,
        ...
        answer: {
            en: "No, you do not need a visa to purchase property in the United States. However, there are important tax, estate planning, and ownership structure considerations for non-resident property owners that we can help you navigate.",
