...
export const practiceAreas: PracticeArea[] = [
  ...
  },
  {
    ...
    icon: 'home',
    shortDescription: 'Property, tax planning, estate structures, and civil law notary services for U.S. assets.',
    ...
    benefits: [
      ...
      'Asset protection strategies',
      'Legal support for property investments',
    ],
    faqs: [
      {
        question: 'Can non-residents buy property in the U.S.?',
        answer:
          'Yes. We help structure purchases and ownership to address tax and succession considerations.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Absolutely. We collaborate with your U.S. and foreign advisors to align legal and tax strategies.',
      },
    ],
